...
gl_view: main.o version.o logfunc.o strfunc.o toolfunc.o filefunc.o
	$(CC) -o gl_view ./obj/main.o ./obj/version.o ./obj/logfunc.o ./obj/strfunc.o ./obj/toolfunc.o ./obj/filefunc.o $(LDFLAGS)
